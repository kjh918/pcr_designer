...
class ASPCRDesignInput(BaseDesignInput):
    ...
    def to_core_pcr_params(self) -> Dict[str, Any]:
        ...
        return {
            "primer_kwargs": {
                ...
                "min_gc": self.primer.get("min_gc", 25.0), # MS-PCR은 저GC 허용
                "opt_gc": self.primer.get("opt_gc", 45.0),
                "max_gc": self.primer.get("max_gc", 85.0),
            }
        }
    ...
    def to_core_qc_overrides(self) -> Dict[str, Any]:
        ...
        overrides = {
            ...
            # BLAST (Alias 포함)
            "min_identity": blast.get("min_identity", 80.0),
            "blast_identity_threshold": blast.get("min_identity", 80.0),
            "min_hit_length": blast.get("min_hit_length", 10),
            "blast_max_alignments": blast.get("max_alignments", 10),
            "max_alignments": blast.get("max_alignments", 10),
            ...
            # Primer Constraints
            "primer": {
                "max_diff_tm": oligo.get("max_tm_diff", 10.0)
            },
