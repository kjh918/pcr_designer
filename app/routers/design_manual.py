...
@router.post("/manual", response_class=HTMLResponse, name="design_manual_from_form")
async def design_manual_from_form(
	...
	try:
		...
		# ✅ CHANGED: 결과를 form_manual.html에서 렌더링할 수 있게 플래그 추가(선택)
		context["manual_result_ready"] = True

	except Exception as e:
		traceback.print_exc()
		context["error"] = str(e)

	# ✅ CHANGED: design.html -> form_manual.html
